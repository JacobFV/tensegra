...
The optional connection adds no parameters or random draws, and independent seeded comparisons found bitexact unchanged default behavior against frozen main source. The [supplement summary](../../results/stage5/selector/analysis/summary.json), [config](../../results/stage5/selector/config.json) and [raw records](../../results/stage5/selector/metrics.jsonl.gz) retain all nine runs. The independent [supplement audit](../../results/stage5/selector/audit.json) passes all nine checkpoints and 261 recorded cells. The [cross-main audit](../../results/stage5/selector/cross-main-pairing.json) verifies identical initialization, training schedules and all evaluation data in 90 paired comparisons; resolved configurations differ only in their variant lists. The final complete regression suite passes 359 tests. The supplement took another 4.9 minutes, for approximately 26.1 minutes total recorded run time across both sweeps.
