...
The acquisition run froze source 1b2860b, verified the initial checkpoint against its archived SHA-256, and completed in 45.90 seconds. Peak allocated CUDA memory was 2.16 GB and process RSS 2.27 GB. Raw predictions, targets, event identities, per-field training losses, parameter counts and checkpoint hashes are in `research/results/stage11/return-acquisition/`. Checkpoints remain immutable on GB10. Independent audit is pending.
