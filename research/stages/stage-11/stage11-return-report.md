...
The full manifest is [losslessly compressed](../../results/stage11/return-main/manifest.json.gz), with compressed and raw hashes in [its receipt](../../results/stage11/return-main/manifest-receipt.json). Original remote JSON and all six output checkpoints remain immutable. Raw predictions include all fields; curves preserve every registered validation checkpoint. Independent final main audit is pending.
