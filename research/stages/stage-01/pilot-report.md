...
The committed raw artifacts are `research/results/pilot-metrics.jsonl` and
`research/results/pilot-summary.json`; the configuration is
...
from `research/results/pilot-metrics.jsonl` and comparing selection, paired
differences, environment, and resource fields with
`research/results/pilot-summary.json`.
