"""Root-only helper for extended-03 jobs on the pro6000 (Windows host, WSL2 Ubuntu).
...
ROOT = "/home/brand/tensegra-campaign03"
PY = f"{ROOT}/env/bin/python"
...
def launch(a):
    ...
    for cfg in a.configs:
        job = Path(cfg).stem
        lines.append(
            f"{ROOT}/bin/detach.sh {job} {ROOT}/source-{a.sha} {PY} research/tools/campaign02_job.py "
...
def fetch(a):
    dest = REPO / "research/results/campaign-03"
