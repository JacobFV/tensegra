"""Reconstruct the prespecified R07 calibration advancement criterion."""
...
for arm in ('linear','residual_mlp'):
 ...
 out['arms'][arm]=info
orig=out['arms']['linear'];bal=out['arms']['residual_mlp'];c=bal['calibration']['minimum'];og=orig['calibration_grid'];bg=bal['calibration_grid']
