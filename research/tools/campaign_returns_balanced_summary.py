"""Reconstruct the prespecified R06 calibration advancement criterion."""
...
for arm in ('unchanged','original','balanced'):
 info={}
 ...
 out['arms'][arm]=info
orig=out['arms']['original'];bal=out['arms']['balanced'];c=bal['calibration']['minimum'];og=orig['calibration_grid'];bg=bal['calibration_grid']
