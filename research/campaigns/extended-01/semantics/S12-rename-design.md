...
The uppercase convention is preserved in visible text, but the actor receives lexical hash vectors rather than an explicit case feature. Novel spellings therefore introduce novel lexical codes. This diagnostic tests syntax/equality/copy robustness under those codes, not learned lexical translation.
