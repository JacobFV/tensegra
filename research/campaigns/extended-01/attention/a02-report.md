...
Exploratory, not confirmation. The registered selection rule chooses strength initialized at8, learned during training, with no explicit node-count correction. No graph-context or message-passing baseline was weakened.
...
The size correction leaves N16 unchanged by construction and largely repairs N32, while the arm initialized at8 also repairs the deeper N16 condition. This pattern agrees with finite nonedge mass accumulating over depth, although the learned dynamics are not identical to the equal-score mathematical fixture.
