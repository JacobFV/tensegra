...
External process occupancy was24.02seconds and peak CUDA allocation1,208,889,856bytes. No automatic longer run was launched. Independent raw/cache audit c538e8a verifies all 84 raw and frozen-cache CPU predictions, exact linear replay, unchanged non-value fields, and the failed acquisition criterion. The next smallest discriminating experiment would hold this readout fixed and reduce its learning rate, with a prospective endpoint and all failures retained; it requires coordinator authorization.
