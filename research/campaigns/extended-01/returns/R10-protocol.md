...
First mechanical profile: same1024backbone,512/2048fitting prefixes,100updates,128mixture rows and8per grid stratum. Separate profile namespace619million. Measure capture, fit, evaluation, compression/export and external whole-process occupancy; source/config/checkpoint hashes required. Suggested profile cap60s, subject to sole root scheduler release. Main estimate250–500s pending measured scaling; no main allocation is fixed before profile. Two linear heads only; no broad sweep.
