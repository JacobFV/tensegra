...
**Spec:** `.development/design.md`, first-milestone sections and the user's sequence/robot-first clarification.
...
**Files:** `.development/results/pilot-summary.json`, `.development/pilot-report.md`, `.development/journal.md`.
