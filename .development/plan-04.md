...
- [x] Specify binding interventions and the conditional adaptive gate.
- [x] Preserve Stage1–3 and implement normalized learned matchers and identity writes.
...
stability threshold on this task is not evidence of general semantic binding.
