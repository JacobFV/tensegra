"""S19 bounded immutable launcher; outer GNUtime/timeout also binds imports."""
...
def main():
 ...
 with log.open('x') as stream:
  try:
   ...
   sys.path.insert(0,str(Path(__file__).parent));from campaign_semantics_s19_freeze import verify
