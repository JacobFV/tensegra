"""Serial diagnostic wrapper including main preflight in full occupancy/cap."""
...
with log.open('x') as stream:
    try:
        ...
        if True:
            ...
            from campaign_semantics_main_freeze import verify_main_source
            matrix=verify_main_source(config,Path(__file__).parent,a.cap)
