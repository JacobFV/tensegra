"""S22 bounded immutable launcher; outer GNUtime/timeout also binds imports."""
...
def main():
 ...
 with log.open('x') as stream:
  try:
   ...
   sys.path.insert(0,str(Path(__file__).resolve().parent.parent));from topoformer.campaign_semantics_s22_freeze import verify
