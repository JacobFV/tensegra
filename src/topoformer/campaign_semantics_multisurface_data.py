...
def make_record(example,vocab,seen_public,seen_features=None):
    ...
    single_slot_labels(graph)  # reject unrepresentable pair slots before target writes
