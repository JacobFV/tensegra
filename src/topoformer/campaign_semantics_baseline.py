...
if __name__=='__main__':
    p=argparse.ArgumentParser();p.add_argument('data_dir');p.add_argument('output');a=p.parse_args();run(a.data_dir,a.output)
