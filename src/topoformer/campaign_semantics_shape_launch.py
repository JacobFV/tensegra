"""S15 serial wrapper including CPU provenance checks in whole occupancy and cap."""
...
command=[a.python,'-m','topoformer.campaign_semantics_shape_train',a.config]
...
with log.open('x') as stream:
    try:
        ...
        if True:
            ...
            from campaign_semantics_shape_freeze import verify
