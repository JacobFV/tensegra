"""A12 inference-only paired localization; no parameter updates or selection."""
import argparse
import hashlib
import json
...
from .campaign_attention_record_diagnostic import forward,POLICIES
...
def run(cfg,out):
    ...
    files=['campaign_attention_records.py','campaign_attention_record_diagnostic.py','campaign_attention_record_diagnostic_study.py','campaign_attention_selector.py','campaign_attention.py']
