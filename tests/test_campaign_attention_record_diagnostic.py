...
from tensegra.campaign_attention_record_diagnostic import forward,POLICIES
from tensegra.campaign_attention_selector import generate,oracle_successors
...
def test_mechanical_export_roundtrip(tmp_path):
    ...
    from tensegra.campaign_attention_record_diagnostic_study import run
